...
class UserLoginsControllerTest < ActionController::TestCase
  ...
  test "should create user_login" do
    assert_difference('UserLogin.count') do
      post :create, user_login: { latitude: @user_login.latitude, longitude: @user_login.longitude, user_id: @user_login.user_id }
    end
  ...
  test "should update user_login" do
    put :update, id: @user_login, user_login: { latitude: @user_login.latitude, longitude: @user_login.longitude, user_id: @user_login.user_id }
    assert_redirected_to user_login_path(assigns(:user_login))
  end
