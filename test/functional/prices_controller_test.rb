...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { definitive: @price.definitive, price: @price.price, store_id: @price.store_id, valoracion: @price.valoracion }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { definitive: @price.definitive, price: @price.price, store_id: @price.store_id, valoracion: @price.valoracion }
    assert_redirected_to price_path(assigns(:price))
  end
